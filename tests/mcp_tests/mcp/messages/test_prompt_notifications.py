...
from mcp_code.mcp_client.messages.prompts.notifications import handle_prompts_list_changed_notification
...
async def test_handle_prompts_list_changed_notification():
    ...
    notification = {"jsonrpc": "2.0", "method": MessageMethod.NOTIFICATION_PROMPTS_LIST_CHANGED}
...
# Assume PromptItem exists or define a mock
