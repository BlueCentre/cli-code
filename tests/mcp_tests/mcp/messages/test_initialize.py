...
from mcp_code.mcp_client.messages.initialize.errors import VersionMismatchError
from mcp_code.mcp_client.messages.initialize.send_messages import InitializeResult, send_initialize
...
async def test_send_initialize_success():
    ...
    async with anyio.create_task_group() as tg:
        ...
        # Client side request
        result = await send_initialize(read_stream=read_receive, write_stream=write_send)
...
async def test_send_initialize_version_mismatch():
    ...
    version_error = {
        ...
        "data": {"supported": ["2024-05-20"], "requested": "2024-11-05"},
    }
...
async def test_send_initialize_different_version():
    ...
    async with anyio.create_task_group() as tg:
        ...
        result = await send_initialize(
            read_stream=read_receive, write_stream=write_send, supported_versions=["2024-11-05", "2024-05-20"]
        )
...
async def test_send_initialize_server_error():
    ...
    # Sample error response
    server_error = {"code": -32603, "message": "Internal server error during initialization"}
