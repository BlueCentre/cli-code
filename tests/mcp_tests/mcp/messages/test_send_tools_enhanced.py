...
from mcp_code.mcp_client.messages.tools.send_messages import send_tools_call
...
async def test_send_tools_call_with_complex_arguments():
    ...
    sample_result = {"content": [{"type": "text", "text": "Found 5 items matching your criteria."}], "isError": False}
    ...
    async with anyio.create_task_group() as tg:
        ...
        # Client side request
        result = await send_tools_call(
            read_stream=read_receive, write_stream=write_send, name="search_products", arguments=complex_args
        )
