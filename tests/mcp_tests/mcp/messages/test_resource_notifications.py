...
from mcp_code.mcp_client.messages.resources.notifications import (
...
async def test_handle_resources_updated_notification():
    ...
    # Create a sample notification
    notification = {"jsonrpc": "2.0", "method": "notifications/resources/updated", "params": {"uri": test_uri}}
...
async def test_handle_resources_updated_notification_wrong_method():
    ...
    # Create a notification with wrong method
    notification = {"jsonrpc": "2.0", "method": "some_other_notification", "params": {"uri": "file:///some/file.txt"}}
...
async def test_resources_notification_client_integration():
    ...
    list_changed_notification = {"jsonrpc": "2.0", "method": "notifications/resources/list_changed"}
