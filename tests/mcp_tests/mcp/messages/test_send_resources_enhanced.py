...
from mcp_code.mcp_client.messages.resources.send_messages import send_resources_read
...
async def test_send_resources_read_binary():
    ...
    sample_content = {"contents": [{"uri": "file:///project/image.png", "mimeType": "image/png", "blob": sample_blob}]}
...
async def test_send_resources_read_directory():
    ...
    sample_content = {
        "contents": [{"uri": "file:///project/src/", "mimeType": "inode/directory", "text": "main.rs\nlib.rs\nutils/"}]
    }
