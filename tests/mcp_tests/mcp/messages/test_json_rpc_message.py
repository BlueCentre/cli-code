# tests/mcp/messages/test_json_rpc_message.py
import pytest
...
class TestJSONRPCMessage:
    ...
    def test_nested_params(self):
        ...
        message = JSONRPCMessage(id="456", method="complex_method", params=nested_params)
    ...
    def test_error_with_data(self):
        ...
        error_with_data = {
            ...
            "data": {"exception": "ValueError", "trace": "File 'app.py', line 42", "timestamp": "2025-03-05T12:34:56Z"},
        }
    ...
    def test_request_and_response_roundtrip(self):
        ...
        success_response = JSONRPCMessage(
            id=request.id, result={"id": 42, "name": "Jane Smith", "email": "jane@example.com"}
        )
        ...
        error_response = JSONRPCMessage(id=request.id, error={"code": -32001, "message": "User not found"})
