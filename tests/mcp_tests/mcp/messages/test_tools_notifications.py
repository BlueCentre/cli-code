...
from mcp_code.mcp_client.messages.tools.notifications import handle_tools_list_changed_notification
...
async def test_tools_notification_client_integration():
    ...
    # Create notification
    list_changed_notification = {"jsonrpc": "2.0", "method": "notifications/tools/list_changed"}
