...
# host imports
from mcp_code.mcp_client.host.environment import get_default_environment
...
class StdioClient:
    ...
    async def __aenter__(self):
        ...
        logging.debug(f"Subprocess started with PID {self.process.pid}, command: {self.server.command}")
